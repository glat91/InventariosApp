...
class GetPendingSalesUseCase @Inject constructor(
    ...
    suspend operator fun invoke(estatusVentaIds: String, startDate: String, endDate: String): Pair<List<SalesModel>?, String?>{
        return getPendingSalesRepositoryImp(estatusVentaIds, startDate, endDate)
    }
}